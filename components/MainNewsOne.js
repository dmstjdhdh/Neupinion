        ...
        <View style={{
            ...
            <ScrollView>
                ...
                <View style={styles.newsContainer}>
                    ...
                    <View style={styles.buttonContainer}>
                        <CustomButtonCut width={108} height={108} cut={15} cardColor={'#7E58E9'} borderRadius={3}>
                            <Text style={{color: 'white', fontSize: 12, marginTop: 15, marginLeft:9, fontWeight: '500', width:90, lineHeight: 16,}}>
                                전원석방 아닌 이상 타협하지마라
                            </Text>
                            <View style={{alignItems: 'flex-start', flexDirection: 'row', marginTop:33, marginLeft: 8}}>
                                <Image source={require('./public/profileicon/one.png')} style={{width:16, height: 16,}}/>
                                <Text style={{color: 'white', fontSize: 11, marginLeft:4, fontWeight: 'normal', width:90, lineHeight: 16,}}>
                                    신미봉
                                </Text>
                            </View>
                        </CustomButtonCut>
                        ...
                        <CustomButtonCut width={108} height={108} cut={15} cardColor={'#7E58E9'} borderRadius={3}>
                            <Text style={{color: 'white', fontSize: 12, marginTop: 15, marginLeft:9, fontWeight: '500', width:90, lineHeight: 16,}}>
                                민간인들은 무슨 죄.. 전쟁은 빨리 멈춰야 한다.
                            </Text>
                            <View style={{alignItems: 'flex-start', flexDirection: 'row', marginTop:16, marginLeft: 8}}>
                                <Image source={require('./public/profileicon/three.png')} style={{width:16, height: 16,}}/>
                                <Text style={{color: 'white', fontSize: 11, marginLeft:4, fontWeight: 'normal', width:90, lineHeight: 16,}}>
                                    지니수
                                </Text>
                            </View>
                        ...
                        <CustomButtonCut width={108} height={108} cut={15} cardColor={'#7E58E9'} borderRadius={3}>
                            <Text style={{color: 'white', fontSize: 12, marginTop: 15, marginLeft:9, fontWeight: '500', width:90, lineHeight: 16,}}>
                                하마스가 인질을 풀어주고 협상에 나서는게 최선일듯.
                            </Text>
                            <View style={{alignItems: 'flex-start', flexDirection: 'row', marginTop:16, marginLeft: 8}}>
                                <Image source={require('./public/profileicon/two.png')} style={{width:16, height: 16,}}/>
                                <Text style={{color: 'white', fontSize: 11, marginLeft:4, fontWeight: 'normal', width:90, lineHeight: 16,}}>
                                    Cheze
                                </Text>
                            </View>
