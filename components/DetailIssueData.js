...
const DetailIssueData = ({navigation}) => {
        ...
        <View style={{
            ...
            <ScrollView>
                ...
                <View style={styles.newsContainer}>
                    ...
                    <Image source={require('./public/Frame2.png')} style={{width:160, height: 165, marginLeft:24, marginBottom: 20, marginTop: 18, alignSelf: 'flex-start'}}/>
...
export default DetailIssueData;